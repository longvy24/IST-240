...
k=Sb.prototype;k.fb=function(){return this.width*this.height};
...
function Yb(a,b){Za(b,function(b,d){b&&b.aa&&(b=b.Z());"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:Zb.hasOwnProperty(d)?a.setAttribute(Zb[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,b):a[d]=b})}
...
a=Zc(a);Sc.test(c)||Oc("invalid_callback");b=$c(b);d=d&&d.length?$c(d):null;return[encodeURIComponent(a.pathPrefix).replace(/%2C/g,",").replace(/%2F/g,"/"),"/k=",e(a.version),"/m=",e(b),d?"/exm="+e(d):"","/rt=j/sv=1/d=1/ed=1",a.ka?"/am="+e(a.ka):"",a.Ea?"/rs="+e(a.Ea):"",a.Na?"/t="+e(a.Na):"","/cb=",e(c)].join("")}
...
"k",!0);d=ad(a,"am");e=ad(a,"rs");a=ad(a,"t");return{pathPrefix:b,version:c,ka:d,Ea:e,Na:a}}
...
var wd;function xd(){if(-1!=String(m.Promise).indexOf("[native code]")){var a=m.Promise.resolve(void 0);wd=function(){a.then(Ad)}}else wd=function(){var a=Ad;
...
k.V=function(a){return[this.getFullYear(),Ra(this.getMonth()+1),Ra(this.getDate())].join(a?"-":"")+""};
...
y(Kd,Hd);Kd.prototype.add=function(a){Hd.prototype.add.call(this,a);a.b&&this.date.setUTCHours(this.date.getUTCHours()+a.b);a.minutes&&this.date.setUTCMinutes(this.date.getUTCMinutes()+a.minutes);a.seconds&&this.date.setUTCSeconds(this.date.getUTCSeconds()+a.seconds)};
Kd.prototype.V=function(a){var b=Hd.prototype.V.call(this,a);return a?b+" "+Ra(this.date.getHours())+":"+Ra(this.date.getMinutes())+":"+Ra(this.date.getSeconds()):b+"T"+Ra(this.date.getHours())+Ra(this.date.getMinutes())+Ra(this.date.getSeconds())};
Kd.prototype.equals=function(a){return this.getTime()==a.getTime()};
Kd.prototype.toString=function(){return this.V()};function Ld(){this.g=this.g;this.j=this.j}
Ld.prototype.g=!1;Ld.prototype.T=function(){return this.g};
Ld.prototype.dispose=function(){this.g||(this.g=!0,this.Y())};
...
Ke.prototype.R=function(a){this.b=0;Le(this,3,a)};
...
function $e(a,b){var c=!1,d=a.subscribe("ROOT_MENU_REMOVED",function(a){c||(c=!0,this.P(d),b.apply(void 0,arguments))},a)}
function af(a,b,c){if(b=a.f[b]){var d=a.b;(b=Ha(b,function(a){return d[a+1]==c&&void 0==d[a+2]}))&&a.P(b)}}
k.P=function(a){var b=this.b[a];if(b){var c=this.f[b];if(0!=this.o)this.l.push(a),this.b[a+1]=ma;else{if(c){var d=Da(c,a);0<=d&&Array.prototype.splice.call(c,d,1)}delete this.b[a];delete this.b[a+1];delete this.b[a+2]}}return!!b};
...
k.Y=function(){N.w.Y.call(this);this.clear();this.l.length=0};function df(a){this.b=a}
...
;var Ff=u("ytPubsubPubsubInstance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.P;N.prototype.publish=N.prototype.F;N.prototype.clear=N.prototype.clear;x("ytPubsubPubsubInstance",Ff);var Gf=u("ytPubsubPubsubSubscribedKeys")||{};x("ytPubsubPubsubSubscribedKeys",Gf);var Hf=u("ytPubsubPubsubTopicToKeys")||{};x("ytPubsubPubsubTopicToKeys",Hf);var If=u("ytPubsubPubsubIsSynchronous")||{};x("ytPubsubPubsubIsSynchronous",If);
...
oa(Tf);Tf.v();var Xf=u("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.P;N.prototype.publish=N.prototype.F;N.prototype.clear=N.prototype.clear;x("ytPubsub2Pubsub2Instance",Xf);var Yf=u("ytPubsub2Pubsub2SubscribedKeys")||{};x("ytPubsub2Pubsub2SubscribedKeys",Yf);var Zf=u("ytPubsub2Pubsub2TopicToKeys")||{};x("ytPubsub2Pubsub2TopicToKeys",Zf);var $f=u("ytPubsub2Pubsub2IsAsync")||{};x("ytPubsub2Pubsub2IsAsync",$f);
...
lg.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var bb=u("ytEventsEventsListeners")||{};x("ytEventsEventsListeners",bb);var mg=u("ytEventsEventsCounter")||{count:0};x("ytEventsEventsCounter",mg);function ng(a,b,c,d){d=void 0===d?!1:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return ab(function(e){return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function V(a,b,c,d){d=void 0===d?!1:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=ng(a,b,c,d);if(e)return e;e=++mg.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(d){d=new lg(d);if(!tc(d.relatedTarget,function(b){return b==a},!0))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new lg(b);
b.currentTarget=a;return c.call(a,b)};
g=Df(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),a.addEventListener(b,g,d)):a.attachEvent("on"+b,g);bb[e]=[a,b,c,g,d];return e}
function og(a,b,c){var d=a||document;return V(d,"click",function(a){var e=tc(a.target,function(a){return a===d||c(a)},!0);
e&&e!==d&&!e.disabled&&(a.currentTarget=e,b.call(e,a))})}
function pg(a){a=a||window.event;a=a.target||a.srcElement;3==a.nodeType&&(a=a.parentNode);return a}
function qg(a,b,c){return og(a,b,function(a){return K(a,c)})}
function rg(a){if(document.createEvent){var b=document.createEvent("HTMLEvents");b.initEvent("click",!0,!0);a.dispatchEvent(b)}else b=document.createEventObject(),a.fireEvent("onclick",b)}
function W(a){a&&("string"==typeof a&&(a=[a]),A(a,function(a){if(a in bb){var b=bb[a],d=b[0],e=b[1],f=b[3];b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete bb[a]}}))}
;var sg={},tg="ontouchstart"in document;function ug(a,b,c){switch(a){case "mouseover":case "mouseout":var d=3;break;case "mouseenter":case "mouseleave":d=9}return tc(c,function(a){return K(a,b)},!0,d)}
function vg(a){var b="mouseover"==a.type&&"mouseenter"in sg||"mouseout"==a.type&&"mouseleave"in sg,c=a.type in sg||b;if("HTML"!=a.target.tagName&&c){if(b){b="mouseover"==a.type?"mouseenter":"mouseleave";c=sg[b];for(var d in c.f){var e=ug(b,d,a.target);e&&!tc(a.relatedTarget,function(a){return a==e},!0)&&c.F(d,e,b,a)}}if(b=sg[a.type])for(d in b.f)(e=ug(a.type,d,a.target))&&b.F(d,e,a.type,a)}}
V(document,"blur",vg,!0);V(document,"change",vg,!0);V(document,"click",vg);V(document,"focus",vg,!0);V(document,"mouseover",vg);V(document,"mouseout",vg);V(document,"mousedown",vg);V(document,"keydown",vg);V(document,"keyup",vg);V(document,"keypress",vg);V(document,"cut",vg);V(document,"paste",vg);tg&&(V(document,"touchstart",vg),V(document,"touchend",vg),V(document,"touchcancel",vg));function wg(a){this.l=a;this.A={};this.J=[];this.C=[]}
k=wg.prototype;k.B=function(a){return G(a,X(this))};
function X(a,b){return"yt-uix"+(a.l?"-"+a.l:"")+(b?"-"+b:"")}
k.unregister=function(){Lf(this.J);this.J.length=0;cg(this.C);this.C.length=0};
k.init=ma;k.dispose=ma;function xg(a,b,c){a.J.push(Jf(b,c,a))}
function yg(a,b,c){a.C.push(bg(b,c,a))}
function Y(a,b,c,d){d=X(a,d);var e=v(c,a);b in sg||(sg[b]=new N);sg[b].subscribe(d,e);a.A[c]=e}
function Z(a,b,c,d){if(b in sg){var e=sg[b];af(e,X(a,d),a.A[c]);0>=cf(e)&&(e.dispose(),delete sg[b])}delete a.A[c]}
...
function zg(a,b){Nf(a,"tooltip-text",b)}
;var Ag=window.yt&&window.yt.uix&&window.yt.uix.widgets_||{};x("yt.uix.widgets_",Ag);function Bg(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=decodeURIComponent((e[0]||"").replace(/\+/g," "));e=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?qa(b[f])?La(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
;function Cg(a){a=void 0===a?{}:a;sa(a)&&(a={callback:a});if(a.gapiHintOverride||O("GAPI_HINT_OVERRIDE")){var b=document.location.href;-1!=b.indexOf("?")?(b=(b||"").split("#")[0],b=b.split("?",2),b=Bg(1<b.length?b[1]:b[0])):b={};(b=b.gapi_jsh)&&db(a,{_c:{jsl:{h:b}}})}ld("gapi.iframes:gapi.iframes.style.common",a)}
;function Dg(){return u("gapi.iframes.getContext")()}
;function Eg(a){R.call(this,1,arguments);this.b=a}
y(Eg,R);function Fg(a){R.call(this,1,arguments);this.b=a}
y(Fg,R);function Gg(a,b,c){R.call(this,3,arguments);this.g=a;this.f=b;this.b=null!=c?!!c:null}
y(Gg,R);function Hg(a,b,c,d,e){R.call(this,2,arguments);this.f=a;this.b=b;this.j=c||null;this.g=d||null;this.source=e||null}
y(Hg,R);function Ig(a,b,c){R.call(this,1,arguments);this.b=a;this.f=b}
y(Ig,R);function Jg(a,b,c,d,e,f,g){R.call(this,1,arguments);this.f=a;this.l=b;this.b=c;this.o=d||null;this.j=e||null;this.g=f||null;this.source=g||null}
y(Jg,R);
var Kg=new S("subscription-batch-subscribe",Eg),Lg=new S("subscription-batch-unsubscribe",Eg),Mg=new S("subscription-subscribe",Hg),Ng=new S("subscription-subscribe-loading",Fg),Og=new S("subscription-subscribe-loaded",Fg),Pg=new S("subscription-subscribe-success",Ig),Qg=new S("subscription-subscribe-external",Hg),Rg=new S("subscription-unsubscribe",Jg),Sg=new S("subscription-unsubscirbe-loading",Fg),Tg=new S("subscription-unsubscribe-loaded",Fg),Ug=new S("subscription-unsubscribe-success",Fg),Vg=
new S("subscription-external-unsubscribe",Jg),Wg=new S("subscription-enable-ypc",Fg),Xg=new S("subscription-disable-ypc",Fg),Yg=new S("subscription-prefs",Gg),Zg=new S("subscription-prefs-success",Gg),$g=new S("subscription-prefs-failure",Gg);function ah(){var a=ig();return a?a:null}
;function bh(a,b){(a=E(a))&&a.style&&(a.style.display=b?"":"none",Qd(a,"hid",!b))}
function ch(a){return(a=E(a))?"none"!=a.style.display&&!K(a,"hid"):!1}
function dh(a){A(arguments,function(a){!ra(a)||a instanceof Element?bh(a,!0):A(a,function(a){dh(a)})})}
function eh(a){A(arguments,function(a){!ra(a)||a instanceof Element?bh(a,!1):A(a,function(a){eh(a)})})}
;function fh(){wg.call(this,"tooltip");this.b=0;this.f={}}
y(fh,wg);oa(fh);k=fh.prototype;k.register=function(){Y(this,"mouseover",this.U);Y(this,"mouseout",this.K);Y(this,"focus",this.qa);Y(this,"blur",this.la);Y(this,"click",this.K);Y(this,"touchstart",this.Ha);Y(this,"touchend",this.W);Y(this,"touchcancel",this.W)};
k.unregister=function(){Z(this,"mouseover",this.U);Z(this,"mouseout",this.K);Z(this,"focus",this.qa);Z(this,"blur",this.la);Z(this,"click",this.K);Z(this,"touchstart",this.Ha);Z(this,"touchend",this.W);Z(this,"touchcancel",this.W);this.dispose();fh.w.unregister.call(this)};
k.dispose=function(){for(var a in this.f)this.K(this.f[a]);this.f={}};
k.U=function(a){if(!(this.b&&1E3>Aa()-this.b)){var b=parseInt(this.i(a,"tooltip-hide-timer"),10);b&&(Qf(a,"tooltip-hide-timer"),window.clearTimeout(b));b=v(function(){gh(this,a);Qf(a,"tooltip-show-timer")},this);
var c=parseInt(this.i(a,"tooltip-show-delay"),10)||0;b=P(b,c);Nf(a,"tooltip-show-timer",b.toString());a.title&&(zg(a,hh(this,a)),a.title="");b=ua(a).toString();this.f[b]=a}};
k.K=function(a){var b=parseInt(this.i(a,"tooltip-show-timer"),10);b&&(window.clearTimeout(b),Qf(a,"tooltip-show-timer"));b=v(function(){if(a){var b=E(ih(this,a));b&&(jh(b),ec(b),Qf(a,"content-id"));b=E(ih(this,a,"arialabel"));ec(b)}Qf(a,"tooltip-hide-timer")},this);
...
k.la=function(a){this.b=0;this.K(a)};
k.Ha=function(a,b,c){c.changedTouches&&(this.b=0,(a=ug(b,X(this),c.changedTouches[0].target))&&this.U(a,b))};
k.W=function(a,b,c){c.changedTouches&&(this.b=Aa(),(a=ug(b,X(this),c.changedTouches[0].target))&&this.K(a))};
function kh(a,b,c){zg(b,c);a=a.i(b,"content-id");(a=E(a))&&ic(a,c)}
function hh(a,b){return a.i(b,"tooltip-text")||b.title}
function gh(a,b){if(b){var c=hh(a,b);if(c){var d=E(ih(a,b));if(!d){d=document.createElement("div");d.id=ih(a,b);d.className=X(a,"tip");var e=document.createElement("div");e.className=X(a,"tip-body");var f=document.createElement("div");f.className=X(a,"tip-arrow");var g=document.createElement("div");g.setAttribute("aria-hidden","true");g.className=X(a,"tip-content");var h=lh(a,b),l=ih(a,b,"content");g.id=l;Nf(b,"content-id",l);e.appendChild(g);h&&d.appendChild(h);d.appendChild(e);d.appendChild(f);
var n=qc(b);l=ih(a,b,"arialabel");f=document.createElement("div");L(f,X(a,"arialabel"));f.id=l;n=b.hasAttribute("aria-label")?b.getAttribute("aria-label"):"rtl"==document.body.getAttribute("dir")?c+" "+n:n+" "+c;ic(f,n);b.setAttribute("aria-labelledby",l);l=ah()||document.body;l.appendChild(f);l.appendChild(d);kh(a,b,c);(c=parseInt(a.i(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",L(g,X(a,"normal-wrap")));g=K(b,X(a,"reverse"));mh(a,b,d,e,h,g)||mh(a,b,d,e,h,!g);var t=X(a,"tip-visible");
P(function(){L(d,t)},0)}}}}
...
function ih(a,b,c){a=X(a)+eg(b);c&&(a+="-"+c);return a}
function lh(a,b){var c=null;sb&&K(b,X(a,"masked"))&&((c=E("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),dh(c)):(c=document.createElement("IFRAME"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",c.className=X(a,"tip-mask")));return c}
function jh(a){var b=E("yt-uix-tooltip-shared-mask"),c=b&&tc(b,function(b){return b==a},!1,2);
b&&c&&(b.parentNode.removeChild(b),eh(b),document.body.appendChild(b))}
;function nh(a){var b=oh();if(b=window.open(b,"loginPopup","width=375,height=440,resizable=yes,scrollbars=yes",!0)){var c=Jf("LOGGED_IN",function(b){Lf(O("LOGGED_IN_PUBSUB_KEY",void 0));Cf("LOGGED_IN",!0);a(b)});
Cf("LOGGED_IN_PUBSUB_KEY",c);b.moveTo((screen.width-375)/2,(screen.height-440)/2)}}
function oh(){var a=document.location.protocol+"//"+document.domain+"/post_login";a=zf(a,"mode","subscribe");a=zf("/signin?context=popup","next",a);return a=zf(a,"feature","sub_button")}
x("yt.pubsub.publish",Q);var ph=Object.create(null);ph.log_event="GENERIC_EVENT_LOGGING";ph.log_interaction="INTERACTION_LOGGING";x("ytLoggingTransportLogPayloadsQueue_",u("ytLoggingTransportLogPayloadsQueue_")||{});x("ytLoggingTransportTokensToCttTargetIds_",u("ytLoggingTransportTokensToCttTargetIds_")||{});x("ytLoggingTransportDispatchedStats_",u("ytLoggingTransportDispatchedStats_")||{});x("ytytLoggingTransportCapturedTime_",u("ytLoggingTransportCapturedTime_")||{});Aa();var qh=p(XMLHttpRequest)?function(){return new XMLHttpRequest}:p(ActiveXObject)?function(){return new ActiveXObject("Microsoft.XMLHTTP")}:null;
function rh(){if(!qh)return null;var a=qh();return"open"in a?a:null}
;var sh={"X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"},th=!1;
function uh(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=a.match(tf)[1]||null,e=uf(a.match(tf)[3]||null);d&&e?(d=c,c=a.match(tf),d=d.match(tf),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?uf(c.match(tf)[3]||null)==e&&(Number(c.match(tf)[4]||null)||null)==(Number(a.match(tf)[4]||null)||null):!0;for(var f in sh){if((e=d=O(sh[f]))&&!(e=c)){e=f;var g=O("CORS_HEADER_WHITELIST")||{},h=uf(a.match(tf)[3]||null);e=h?(g=g[h])?Ia(g,e):!1:!0}e&&(b[f]=d)}return b}
function vh(a,b){var c=b.format||"JSON";a=wh(a,b);var d=xh(a,b),e=!1,f,g=yh(a,function(a){if(!e){e=!0;f&&window.clearTimeout(f);a:switch(a&&"status"in a?a.status:-1){case 200:case 201:case 202:case 203:case 204:case 205:case 206:case 304:var d=!0;break a;default:d=!1}var g=null;if(d||400<=a.status&&500>a.status)g=zh(c,a,b.Qb);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};var h=b.context||m;d?b.O&&b.O.call(h,
a,g):b.onError&&b.onError.call(h,a,g);b.ca&&b.ca.call(h,a,g)}},b.method,d,b.headers,b.responseType,b.withCredentials);
b.yb&&0<b.timeout&&(f=P(function(){e||(e=!0,g.abort(),window.clearTimeout(f),b.yb.call(b.context||m,g))},b.timeout))}
function wh(a,b){b.Sb&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=O("XSRF_FIELD_NAME",void 0),d=b.Ia;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=Bg(f[1]||"");for(var g in d)f[g]=d[g];a=Af(c,f)+e}return a}
function xh(a,b){var c=O("XSRF_FIELD_NAME",void 0),d=O("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.L,g=O("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.Rb||uf(a.match(tf)[3]||null)&&!b.withCredentials&&uf(a.match(tf)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.L&&b.L[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=Bg(e),db(e,f),e=b.Bb&&"JSON"==b.Bb?JSON.stringify(e):yf(e));if(!(c=e)&&(c=f)){a:{for(var l in f){f=!1;break a}f=!0}c=!f}!th&&
c&&"POST"!=b.method&&(th=!0,Ef(Error("AJAX request with postData should use POST")));return e}
function zh(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?Ah(b):null)d={},A(b.getElementsByTagName("*"),function(a){d[a.tagName]=Bh(a)})}c&&Ch(d);
return d}
function Ch(a){if(ta(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Qb(a[b]);a[c]=d}else Ch(a[b])}}
function Ah(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Bh(a){var b="";A(a.childNodes,function(a){b+=a.nodeValue});
return b}
function yh(a,b,c,d,e,f,g){function h(){4==(l&&"readyState"in l?l.readyState:0)&&b&&Df(b)(l)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var l=rh();if(!l)return null;"onloadend"in l?l.addEventListener("loadend",h,!1):l.onreadystatechange=h;l.open(c,a,!0);f&&(l.responseType=f);g&&(l.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=uh(a,e))for(var n in e)l.setRequestHeader(n,e[n]),"content-type"==n.toLowerCase()&&(c=!1);c&&l.setRequestHeader("Content-Type","application/x-www-form-urlencoded");l.send(d);return l}
;function Dh(){var a=new mf;(a=a.isAvailable()?new sf(a,"yt.innertube"):null)||(a=new nf("yt.innertube"),a=a.isAvailable()?a:null);this.b=a?new hf(a):null;this.f=document.domain||window.location.hostname}
Dh.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.b)try{this.b.set(a,b,Aa()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(de(b))}catch(f){return}else e=escape(b);b=this.f;Hc.set(""+a,e,c,"/",void 0===b?"youtube.com":b,!1)};
Dh.prototype.get=function(a,b){var c=void 0,d=!this.b;if(!d)try{c=this.b.get(a)}catch(e){d=!0}if(d&&(c=Hc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Dh.prototype.remove=function(a){this.b&&this.b.remove(a);var b=this.f;Hc.remove(""+a,"/",void 0===b?"youtube.com":b)};new Dh;var Eh=Aa().toString();var Fh;a:{if(window.crypto&&window.crypto.getRandomValues)try{var Gh=Array(16),Hh=new Uint8Array(16);window.crypto.getRandomValues(Hh);for(var Ih=0;Ih<Gh.length;Ih++)Gh[Ih]=Hh[Ih];Fh=Gh;break a}catch(a){}for(var Jh=Array(16),Kh=0;16>Kh;Kh++){for(var Lh=Aa(),Mh=0;Mh<Lh%23;Mh++)Jh[Kh]=Math.random();Jh[Kh]=Math.floor(256*Math.random())}if(Eh)for(var Nh=1,Oh=0;Oh<Eh.length;Oh++)Jh[Nh%16]=Jh[Nh%16]^Jh[(Nh-1)%16]/4^Eh.charCodeAt(Oh),Nh++;Fh=Jh}
for(var Ph=Fh,Qh=[],Rh=0;Rh<Ph.length;Rh++)Qh.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(Ph[Rh]&63));function Sh(){wg.call(this,"button");this.b=null;this.g=[];this.f={}}
y(Sh,wg);oa(Sh);k=Sh.prototype;k.register=function(){Y(this,"click",this.Ja);Y(this,"keydown",this.ua);Y(this,"keypress",this.va);xg(this,"page-scroll",this.lb)};
k.unregister=function(){Z(this,"click",this.Ja);Z(this,"keydown",this.ua);Z(this,"keypress",this.va);Th(this);this.f={};Sh.w.unregister.call(this)};
k.Ja=function(a){a&&!a.disabled&&(this.toggle(a),this.click(a))};
k.ua=function(a,b,c){if(!(c.altKey||c.ctrlKey||c.shiftKey||c.metaKey)&&(b=Uh(this,a))){var d=function(a){var b="";a.tagName&&(b=a.tagName.toLowerCase());return"ul"==b||"table"==b},e;
d(b)?e=b:e=jc(b,d);if(e){e=e.tagName.toLowerCase();if("ul"==e)var f=this.sb;else"table"==e&&(f=this.rb);f&&Vh(this,a,b,c,v(f,this))}}};
k.lb=function(){var a=this.f,b=0;for(d in a)b++;if(0!=b)for(var c in a){b=a[c];var d=G(b.activeButtonNode||b.parentNode,X(this));if(void 0==d||void 0==b)break;Wh(this,d,b,!0)}};
function Vh(a,b,c,d,e){var f=ch(c),g=9==d.keyCode;if(g||32==d.keyCode||13==d.keyCode)if(d=Xh(a,c)){if(p(d.firstElementChild))b=d.firstElementChild;else for(b=d.firstChild;b&&1!=b.nodeType;)b=b.nextSibling;if("a"==b.tagName.toLowerCase()){var h=void 0===h?{}:h;var l=void 0===l?"":l;var n=void 0===n?window:n;n=n.location;h=Af(b.href,h)+l;h instanceof Jb||h instanceof Jb||(h=h.aa?h.Z():String(h),Lb.test(h)||(h="about:invalid#zClosurez"),h=Mb(h));h instanceof Jb&&h.constructor===Jb&&h.f===Kb?h=h.b:(pa(h),
h="type_error:SafeUrl");n.href=h}else rg(b)}else g&&Yh(a,b);else f?27==d.keyCode?(Xh(a,c),Yh(a,b)):e(b,c,d):(h=K(b,X(a,"reverse"))?38:40,d.keyCode==h&&(rg(b),d.preventDefault()))}
k.va=function(a,b,c){c.altKey||c.ctrlKey||c.shiftKey||c.metaKey||(a=Uh(this,a),ch(a)&&c.preventDefault())};
function Xh(a,b){var c=X(a,"menu-item-highlight"),d=F(c,b);d&&M(d,c);return d}
function Zh(a,b,c){L(c,X(a,"menu-item-highlight"));var d=c.getAttribute("id");d||(d=X(a,"item-id-"+ua(c)),c.setAttribute("id",d));b.setAttribute("aria-activedescendant",d)}
k.rb=function(a,b,c){var d=Xh(this,b);if(d){var e=hg("table",b);b=Xb(document,"td",null,e);d=$h(d,b,Xb(document,"td",null,hg("tr",e)).length,c);-1!=d&&(Zh(this,a,b[d]),c.preventDefault())}};
k.sb=function(a,b,c){if(40==c.keyCode||38==c.keyCode){var d=Xh(this,b);d&&(b=Ea(Xb(document,"li",null,b),ch),Zh(this,a,b[$h(d,b,1,c)]),c.preventDefault())}};
function $h(a,b,c,d){var e=b.length;a=Da(b,a);if(-1==a)if(38==d.keyCode)a=e-c;else{if(37==d.keyCode||38==d.keyCode||40==d.keyCode)a=0}else 39==d.keyCode?(a%c==c-1&&(a-=c),a+=1):37==d.keyCode?(0==a%c&&(a+=c),--a):38==d.keyCode?(a<c&&(a+=e),a-=c):40==d.keyCode&&(a>=e-c&&(a-=e),a+=c);return a}
function ai(a,b){var c=b.iframeMask;c||(c=document.createElement("IFRAME"),c.src='javascript:""',c.className=X(a,"menu-mask"),eh(c),b.iframeMask=c);return c}
function Wh(a,b,c,d){var e=G(b,X(a,"group")),f=!!a.i(b,"button-menu-ignore-group");e=e&&!f?e:b;f=9;var g=8,h=ye(b);if(K(b,X(a,"reverse"))){f=8;g=9;h=h.top+"px";try{c.style.maxHeight=h}catch(t){}}K(b,"flip")&&(K(b,X(a,"reverse"))?(f=12,g=13):(f=13,g=12));var l;a.i(b,"button-has-sibling-menu")?l=re(e):a.i(b,"button-menu-root-container")&&(l=bi(a,b));C&&!Eb("8")&&(l=null);if(l){var n=ye(l);n=new je(-n.top,n.left,n.top,-n.left)}l=new D(0,1);K(b,X(a,"center-menu"))&&(l.x-=Math.round((we(c).width-we(b).width)/
2));d&&(l.y+=bc(document).y);if(a=ai(a,b))b=we(c),a.style.width=b.width+"px",a.style.height=b.height+"px",He(e,f,a,g,l,n,197),d&&le(a,"position","fixed");He(e,f,c,g,l,n,197)}
function bi(a,b){if(a.i(b,"button-menu-root-container")){var c=a.i(b,"button-menu-root-container");return G(b,c)}return document.body}
k.La=function(a){if(a){var b=Uh(this,a);if(b){a.setAttribute("aria-pressed","true");a.setAttribute("aria-expanded","true");b.originalParentNode=b.parentNode;b.activeButtonNode=a;b.parentNode.removeChild(b);var c;this.i(a,"button-has-sibling-menu")?c=a.parentNode:c=bi(this,a);c.appendChild(b);b.style.minWidth=a.offsetWidth-2+"px";var d=ai(this,a);d&&c.appendChild(d);(c=!!this.i(a,"button-menu-fixed"))&&(this.f[eg(a).toString()]=b);Wh(this,a,b,c);Mf("yt-uix-button-menu-before-show",a,b);dh(b);d&&dh(d);
this.N(a,"button-menu-action",!0);L(a,X(this,"active"));b=v(this.Ka,this,a,!1);d=v(this.Ka,this,a,!0);c=v(this.Db,this,a,void 0);this.b&&Uh(this,this.b)==Uh(this,a)||Th(this);Q("yt-uix-button-menu-show",a);W(this.g);this.g=[V(document,"click",d),V(document,"contextmenu",b),V(window,"resize",c)];this.b=a}}};
function Yh(a,b){if(b){var c=Uh(a,b);if(c){a.b=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");eh(c);a.N(b,"button-menu-action",!1);var d=ai(a,b),e=eg(c).toString();delete a.f[e];P(function(){d&&d.parentNode&&(eh(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}e=G(b,X(a,"group"));
var f=[X(a,"active")];e&&f.push(X(a,"group-active"));Pd(b,f);Q("yt-uix-button-menu-hide",b);W(a.g);a.g.length=0}}
k.Db=function(a,b){var c=Uh(this,a);if(c){b&&(b instanceof Nb?c.innerHTML=Pb(b):ic(c,b));var d=!!this.i(a,"button-menu-fixed");Wh(this,a,c,d)}};
k.Ka=function(a,b,c){c=pg(c);var d=G(c,X(this));if(d){d=Uh(this,d);var e=Uh(this,a);if(d==e)return}d=G(c,X(this,"menu"));e=d==Uh(this,a);var f=K(c,X(this,"menu-item")),g=K(c,X(this,"menu-close"));if(!d||e&&(f||g))Yh(this,a),d&&b&&this.i(a,"button-menu-indicate-selected")&&((a=F(X(this,"content"),a))&&ic(a,qc(c)),ci(this,d,c))};
function ci(a,b,c){var d=X(a,"menu-item-selected");A(Wb(d,b),function(a){M(a,d)});
L(c.parentNode,d)}
function Uh(a,b){if(!b.widgetMenu){var c=a.i(b,"button-menu-id");c=c&&E(c);var d=X(a,"menu");c?Od(c,[d,X(a,"menu-external")]):c=F(d,b);b.widgetMenu=c}return b.widgetMenu}
...
k.click=function(a){if(Uh(this,a)){var b=Uh(this,a);if(b){var c=G(b.activeButtonNode||b.parentNode,X(this));c&&c!=a?(Yh(this,c),P(v(this.La,this,a),1)):ch(b)?Yh(this,a):this.La(a)}a.focus()}this.N(a,"button-action")};
function Th(a){a.b&&Yh(a,a.b)}
;function di(a){wg.call(this,a);this.g=null}
y(di,wg);k=di.prototype;k.B=function(a){var b=wg.prototype.B.call(this,a);return b?b:a};
k.register=function(){xg(this,"yt-uix-kbd-nav-move-out-done",this.hide)};
k.dispose=function(){ei(this);di.w.dispose.call(this)};
k.i=function(a,b){var c=di.w.i.call(this,a,b);return c?c:(c=di.w.i.call(this,a,"card-config"))&&(c=u(c))&&c[b]?c[b]:null};
k.show=function(a){var b=this.B(a);if(b){L(b,X(this,"active"));var c=fi(this,a,b);if(c){c.cardTargetNode=a;c.cardRootNode=b;gi(this,a,c);var d=X(this,"card-visible"),e=this.i(a,"card-delegate-show")&&this.i(b,"card-action");this.N(b,"card-action",a);this.g=a;eh(c);P(v(function(){e||(dh(c),Q("yt-uix-card-show",b,a,c));hi(c);L(c,d);Q("yt-uix-kbd-nav-move-in-to",c)},this),10)}}};
function fi(a,b,c){var d=c||b,e=X(a,"card");c=ii(a,d);var f=E(X(a,"card")+eg(d));if(f)return a=F(X(a,"card-body"),f),hc(a,c)||(ec(c),a.appendChild(c)),f;f=document.createElement("div");f.id=X(a,"card")+eg(d);f.className=e;(d=a.i(d,"card-class"))&&Od(f,d.split(/\s+/));d=document.createElement("div");d.className=X(a,"card-border");b=a.i(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var g=document.createElement("div");
...
k.hide=function(a){if(a=this.B(a)){var b=E(X(this,"card")+eg(a));b&&(M(a,X(this,"active")),M(b,X(this,"card-visible")),eh(b),this.g=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(ec(b.cardMask),b.cardMask=null))}};
function ei(a){a.g&&a.hide(a.g)}
k.Cb=function(a,b){var c=this.B(a);if(c){if(b){var d=ii(this,c);if(!d)return;b instanceof Nb?d.innerHTML=Pb(b):ic(d,b)}K(c,X(this,"active"))&&(c=fi(this,a,c),gi(this,a,c),dh(c),hi(c))}};
k.isActive=function(a){return(a=this.B(a))?K(a,X(this,"active")):!1};
function ii(a,b){var c=b.cardContentNode;if(!c){var d=X(a,"content"),e=X(a,"card-content");(c=(c=a.i(b,"card-id"))?E(c):F(d,b))||(c=document.createElement("div"));var f=c;M(f,d);L(f,e);b.cardContentNode=c}return c}
function hi(a){var b=a.cardMask;b||(b=document.createElement("IFRAME"),b.src='javascript:""',Od(b,["yt-uix-card-iframe-mask"]),a.cardMask=b);b.style.position=a.style.position;b.style.top=a.style.top;b.style.left=a.offsetLeft+"px";b.style.height=a.clientHeight+"px";b.style.width=a.clientWidth+"px";document.body.appendChild(b)}
;function ji(){wg.call(this,"kbd-nav")}
var ki;y(ji,wg);oa(ji);k=ji.prototype;k.register=function(){Y(this,"keydown",this.sa);xg(this,"yt-uix-kbd-nav-move-in",this.Aa);xg(this,"yt-uix-kbd-nav-move-in-to",this.tb);xg(this,"yt-uix-kbd-move-next",this.Ba);xg(this,"yt-uix-kbd-nav-move-to",this.S)};
k.unregister=function(){Z(this,"keydown",this.sa);W(ki)};
k.sa=function(a,b,c){var d=c.keyCode;if(a=G(a,X(this)))switch(d){case 13:case 32:this.Aa(a);break;case 27:c.preventDefault();c.stopImmediatePropagation();a:{for(c=Ud(a,"kbdNavMoveOut");!c;){c=G(a.parentElement,X(this));if(!c)break a;c=Ud(c,"kbdNavMoveOut")}c=E(c);this.S(c);Q("yt-uix-kbd-nav-move-out-done",c)}break;case 40:case 38:if((b=c.target)&&K(a,X(this,"list")))switch(d){case 40:this.Ba(b,a);break;case 38:d=document.activeElement==a,a=li(a),b=a.indexOf(b),0>b&&!d||(b=d?a.length-1:(a.length+b-
1)%a.length,a[b].focus(),mi(this,a[b]))}c.preventDefault()}};
k.Aa=function(a){var b=Ud(a,"kbdNavMoveIn");b=E(b);ni(this,a,b);this.S(b)};
k.tb=function(a){a:{var b=document;try{var c=b&&b.activeElement;break a}catch(d){}c=null}ni(this,c,a);this.S(a)};
k.S=function(a){if(a)if(nc(a))a.focus();else{var b=jc(a,function(a){return gc(a)?nc(a):!1});
b?b.focus():(a.setAttribute("tabindex","-1"),a.focus())}};
function ni(a,b,c){if(b&&c)if(L(c,X(a)),a=b.id,a||(a="kbd-nav-"+Math.floor(1E6*Math.random()+1),b.id=a),b=a,Td&&c.dataset)c.dataset.kbdNavMoveOut=b;else{if(/-[a-z]/.test("kbdNavMoveOut"))throw Error("");c.setAttribute("data-"+"kbdNavMoveOut".replace(/([A-Z])/g,"-$1").toLowerCase(),b)}}
k.Ba=function(a,b){var c=document.activeElement==b,d=li(b),e=d.indexOf(a);0>e&&!c||(c=c?0:(e+1)%d.length,d[c].focus(),mi(this,d[c]))};
function mi(a,b){if(b){var c=sc(b,"LI");c&&(L(c,X(a,"highlight")),ki=V(b,"blur",v(function(a){M(a,X(this,"highlight"));W(ki)},a,c)))}}
function li(a){if("UL"!=a.tagName.toUpperCase())return[];a=Ea(fc(a),function(a){return"LI"==a.tagName.toUpperCase()});
return Ea(Fa(a,function(a){return ch(a)?jc(a,function(a){return gc(a)?nc(a):!1}):!1}),function(a){return!!a})}
;function oi(){wg.call(this,"menu");this.f=this.b=null;this.g={};this.o={};this.j=null}
y(oi,wg);oa(oi);function pi(a){var b=oi.v();if(K(a,X(b)))return a;var c=b.B(a);return c?c:G(a,X(b,"content"))==b.b?b.f:null}
k=oi.prototype;k.register=function(){Y(this,"click",this.ra);Y(this,"mouseenter",this.jb);xg(this,"page-scroll",this.mb);xg(this,"yt-uix-kbd-nav-move-out-done",function(a){a=this.B(a);qi(this,a)});
this.j=new N};
k.unregister=function(){Z(this,"click",this.ra);this.f=this.b=null;W(Oa($a(this.g)));this.g={};Za(this.o,function(a){ec(a)},this);
this.o={};Md(this.j);this.j=null;oi.w.unregister.call(this)};
k.ra=function(a,b,c){a&&(b=ri(this,a),!b.disabled&&gg(c.target,b)&&si(this,a))};
k.jb=function(a,b,c){a&&K(a,X(this,"hover"))&&gg(c.target,ri(this,a))&&si(this,a,!0)};
k.mb=function(){this.b&&this.f&&ti(this,this.f,this.b)};
function ti(a,b,c){var d=ui(a,b);if(d){var e=we(c);if(e instanceof Sb){var f=e.height;e=e.width}else throw Error("missing height argument");d.style.width=ve(e,!0);d.style.height=ve(f,!0)}c==a.b&&(e=9,f=8,K(b,X(a,"reversed"))&&(e^=1,f^=1),K(b,X(a,"flipped"))&&(e^=4,f^=4),a=new D(0,1),d&&He(b,e,d,f,a,null,197),He(b,e,c,f,a,null,197))}
function si(a,b,c){vi(a,b)&&!c?qi(a,b):(wi(a,b),!a.b||gg(b,a.b)?a.Ma(b):$e(a.j,v(a.Ma,a,b)))}
k.Ma=function(a){if(a){var b=xi(this,a);if(b){Mf("yt-uix-menu-before-show",a,b);this.b?gg(a,this.b)||qi(this,this.f):(this.f=a,this.b=b,K(a,X(this,"sibling-content"))||(ec(b),document.body.appendChild(b)),b.style.minWidth=ri(this,a).offsetWidth-2+"px");var c=ui(this,a);c&&b.parentNode&&b.parentNode.insertBefore(c,b.nextSibling);M(b,X(this,"content-hidden"));ti(this,a,b);Od(ri(this,a),[X(this,"trigger-selected"),"yt-uix-button-toggled"]);Q("yt-uix-menu-show",a);yi(b);zi(this,a);Q("yt-uix-kbd-nav-move-in-to",
b);var d=v(this.Eb,this,a),e=v(this.pb,this,a);c=ua(a).toString();this.g[c]=[V(b,"click",e),V(document,"click",d)];K(a,X(this,"indicate-selected"))&&(d=v(this.qb,this,a),this.g[c].push(V(b,"click",d)));K(a,X(this,"hover"))&&(a=v(this.kb,this,a),this.g[c].push(V(document,"mousemove",a)))}}};
k.kb=function(a,b){var c=pg(b);c&&(gg(c,ri(this,a))||Ai(this,c)||Bi(this,a))};
k.Eb=function(a,b){var c=pg(b);if(c){if(Ai(this,c)){var d=G(c,X(this,"content")),e=sc(c,"LI");e&&d&&hc(d,e)&&Mf("yt-uix-menu-item-clicked",c);c=G(c,X(this,"close-on-select"));if(!c)return;d=pi(c)}qi(this,d||a)}};
function wi(a,b){if(b){var c=G(b,X(a,"content"));c&&A(Wb(X(a),c),function(a){!gg(a,b)&&vi(this,a)&&Bi(this,a)},a)}}
function qi(a,b){if(b){var c=[];c.push(b);var d=xi(a,b);d&&(d=Wb(X(a),d),d=Ka(d),c=c.concat(d),A(c,function(a){vi(this,a)&&Bi(this,a)},a))}}
function Bi(a,b){if(b){var c=xi(a,b);Pd(ri(a,b),[X(a,"trigger-selected"),"yt-uix-button-toggled"]);L(c,X(a,"content-hidden"));var d=xi(a,b);d&&Yb(d,{"aria-expanded":"false"});(d=ui(a,b))&&d.parentNode&&ec(d);c&&c==a.b&&(a.f.appendChild(c),a.b=null,a.f=null,a.j&&a.j.F("ROOT_MENU_REMOVED"));Q("yt-uix-menu-hide",b);c=ua(b).toString();W(a.g[c]);delete a.g[c]}}
k.pb=function(a,b){var c=pg(b);c&&Ci(this,a,c)};
k.qb=function(a,b){var c=pg(b);if(c){var d=ri(this,a);if(d&&(c=sc(c,"LI")))if(c=qc(c).trim(),d.hasChildNodes()){var e=Sh.v();(d=F(X(e,"content"),d))&&ic(d,c)}else ic(d,c)}};
function zi(a,b){var c=xi(a,b);if(c){A(c.children,function(a){"LI"==a.tagName&&Yb(a,{role:"menuitem"})});
Yb(c,{"aria-expanded":"true"});var d=c.id;d||(d="aria-menu-id-"+ua(c),c.id=d);(c=ri(a,b))&&Yb(c,{"aria-controls":d})}}
function Ci(a,b,c){var d=xi(a,b);d&&K(b,X(a,"checked"))&&(a=sc(c,"LI"))&&(a=F("yt-ui-menu-item-checked-hid",a))&&(A(Wb("yt-ui-menu-item-checked",d),function(a){Rd(a,"yt-ui-menu-item-checked","yt-ui-menu-item-checked-hid")}),Rd(a,"yt-ui-menu-item-checked-hid","yt-ui-menu-item-checked"))}
function vi(a,b){var c=xi(a,b);return c?!K(c,X(a,"content-hidden")):!1}
function yi(a){A(Xb(document,"UL",null,a),function(a){a.tabIndex=0;var b=ji.v();Od(a,[X(b),X(b,"list")])})}
function xi(a,b){var c=Pf(b,"menu-content-id");return c&&(c=E(c))?(Od(c,[X(a,"content"),X(a,"content-external")]),c):b==a.f?a.b:F(X(a,"content"),b)}
function ui(a,b){var c=ua(b).toString(),d=a.o[c];if(!d){d=document.createElement("IFRAME");d.src='javascript:""';var e=[X(a,"mask")];A(Nd(b),function(a){e.push(a+"-mask")});
Od(d,e);a.o[c]=d}return d||null}
function ri(a,b){return F(X(a,"trigger"),b)}
function Ai(a,b){return gg(b,a.b)||gg(b,a.f)}
;function Di(){di.call(this,"clickcard");this.b={};this.f={}}
y(Di,di);oa(Di);k=Di.prototype;k.register=function(){Di.w.register.call(this);Y(this,"click",this.oa,"target");Y(this,"click",this.na,"close")};
k.unregister=function(){Di.w.unregister.call(this);Z(this,"click",this.oa,"target");Z(this,"click",this.na,"close");for(var a in this.b)W(this.b[a]);this.b={};for(a in this.f)W(this.f[a]);this.f={}};
k.oa=function(a,b,c){c.preventDefault();b=sc(c.target,"button");if(!b||!b.disabled){if(b=this.i(a,"card-target"))a=document,a=r(b)?a.getElementById(b):b;b=this.B(a);this.i(b,"disabled")||(K(b,X(this,"active"))?(this.hide(a),M(b,X(this,"active"))):(this.show(a),L(b,X(this,"active"))))}};
k.show=function(a){Di.w.show.call(this,a);var b=this.B(a),c=ua(a).toString();if(!Pf(b,"click-outside-persists")){if(this.b[c])return;b=V(document,"click",v(this.pa,this,a));var d=V(window,"blur",v(this.pa,this,a));this.b[c]=[b,d]}a=V(window,"resize",v(this.Cb,this,a,void 0));this.f[c]=a};
k.hide=function(a){Di.w.hide.call(this,a);a=ua(a).toString();var b=this.b[a];b&&(W(b),this.b[a]=null);if(b=this.f[a])W(b),delete this.f[a]};
k.pa=function(a,b){var c="yt-uix"+(this.l?"-"+this.l:"")+"-card",d=null;b.target&&(d=G(b.target,c)||G(pi(b.target),c));(d=d||G(document.activeElement,c)||G(pi(document.activeElement),c))||this.hide(a)};
k.na=function(a){(a=G(a,X(this,"card")))&&(a=a.cardTargetNode)&&this.hide(a)};function Ei(){di.call(this,"hovercard")}
y(Ei,di);oa(Ei);k=Ei.prototype;k.register=function(){Y(this,"mouseenter",this.wa,"target");Y(this,"mouseleave",this.ya,"target");Y(this,"mouseenter",this.xa,"card");Y(this,"mouseleave",this.za,"card")};
...
k.wa=function(a){if(Fi!=a){Fi&&(this.hide(Fi),Fi=null);var b=v(this.show,this,a),c=parseInt(this.i(a,"delay-show"),10);b=P(b,-1<c?c:200);Nf(a,"card-timer",b.toString());Fi=a;a.alt&&(Nf(a,"card-alt",a.alt),a.alt="");a.title&&(Nf(a,"card-title",a.title),a.title="")}};
k.ya=function(a){var b=parseInt(this.i(a,"card-timer"),10);window.clearTimeout(b);this.B(a).isCardHidable=!0;b=parseInt(this.i(a,"delay-hide"),10);b=-1<b?b:200;P(v(this.nb,this,a),b);if(b=this.i(a,"card-alt"))a.alt=b;if(b=this.i(a,"card-title"))a.title=b};
k.nb=function(a){this.B(a).isCardHidable&&(this.hide(a),Fi=null)};
k.xa=function(a){a&&(a.cardRootNode.isCardHidable=!1)};
k.za=function(a){a&&this.hide(a.cardTargetNode)};
var Fi=null;function Gi(a,b,c,d,e,f){this.b=a;this.A=null;this.g=F("yt-dialog-fg",this.b)||this.b;if(a=F("yt-dialog-title",this.g)){var g="yt-dialog-title-"+ua(this.g);a.setAttribute("id",g);this.g.setAttribute("aria-labelledby",g)}this.g.setAttribute("tabindex","-1");this.R=F("yt-dialog-focus-trap",this.b);this.fa=!1;this.j=new N;this.C=[];this.C.push(qg(this.b,v(this.ub,this),"yt-dialog-dismiss"));this.C.push(V(this.R,"focus",v(this.ib,this),!0));Hi(this);this.Qa=b;this.Xa=c;this.Wa=d;this.J=e;this.Ya=f;this.o=
this.l=null}
var Ii={LOADING:"loading",Hb:"content",Ob:"working"};function Ji(a,b){a.T()||a.j.subscribe("post-all",b)}
function Hi(a){a=F("yt-dialog-fg-content",a.b);var b=[];Za(Ii,function(a){b.push("yt-dialog-show-"+a)});
Pd(a,b);L(a,"yt-dialog-show-content")}
k=Gi.prototype;
k.show=function(){if(!this.T()){this.A=document.activeElement;if(!this.Wa){this.f||(this.f=E("yt-dialog-bg"),this.f||(this.f=document.createElement("div"),this.f.id="yt-dialog-bg",this.f.className="yt-dialog-bg",document.body.appendChild(this.f)));var a=window,b=a.document;var c=0;if(b){c=b.body;var d=b.documentElement;if(d&&c)if(a=$b(a).height,ac(b)&&d.scrollHeight)c=d.scrollHeight!=a?d.scrollHeight:d.offsetHeight;else{b=d.scrollHeight;var e=d.offsetHeight;d.clientHeight!=e&&(b=c.scrollHeight,e=
c.offsetHeight);c=b>a?b>e?b:e:b<e?b:e}else c=0}this.f.style.height=c+"px";dh(this.f)}this.ta();c=Ki(this);Li(c);this.l=V(document,"keydown",v(this.ob,this));c=this.b;d=Jf("player-added",this.ta,this);Nf(c,"player-ready-pubsub-key",d);this.Xa&&(this.o=V(document,"click",v(this.Ab,this)));dh(this.b);this.g.setAttribute("tabindex","0");Mi(this);this.J||L(document.body,"yt-dialog-active");Th(Sh.v());ei(Di.v());ei(Ei.v());Q("yt-ui-dialog-show-complete",this)}};
function Ni(){return Ga(Wb("yt-dialog"),function(a){return ch(a)})}
k.ta=function(){if(!this.Ya){var a=this.b;Qd(document.body,"hide-players",!0);a&&Qd(a,"preserve-players",!0)}};
function Ki(a){var b=Xb(document,"iframe",null,a.b);A(b,function(a){var b=Pf(a,"onload");b&&(b=u(b))&&V(a,"load",b);if(b=Pf(a,"src"))a.src=b},a);
return Ka(b)}
function Li(a){A(document.getElementsByTagName("iframe"),function(b){-1==Da(a,b)&&L(b,"iframe-hid")})}
function Oi(){A(Wb("iframe-hid"),function(a){M(a,"iframe-hid")})}
k.ub=function(a){a=a.currentTarget;a.disabled||(a=Pf(a,"action")||"",this.dismiss(a))};
k.dismiss=function(a){if(!this.T()){this.j.F("pre-all");this.j.F("pre-"+a);eh(this.b);ei(Di.v());ei(Ei.v());this.g.setAttribute("tabindex","-1");Ni()||(eh(this.f),this.J||M(document.body,"yt-dialog-active"),jg(),Oi());this.l&&(W(this.l),this.l=null);this.o&&(W(this.o),this.o=null);var b=this.b;if(b){var c=Pf(b,"player-ready-pubsub-key");c&&(Lf(c),Qf(b,"player-ready-pubsub-key"))}this.j.F("post-all");Q("yt-ui-dialog-hide-complete",this);"cancel"==a&&Q("yt-ui-dialog-cancelled",this);this.j&&this.j.F("post-"+
...
k.dispose=function(){ch(this.b)&&this.dismiss("dispose");W(this.C);this.C.length=0;P(v(function(){this.A=null},this),0);
this.R=this.g=null;this.j.dispose();this.j=null;this.fa=!0};
k.ib=function(a){a.stopPropagation();Mi(this)};
function Mi(a){P(v(function(){this.g&&this.g.focus()},a),0)}
x("yt.ui.Dialog",Gi);function Pi(){wg.call(this,"overlay");this.j=this.f=this.g=this.b=null}
y(Pi,wg);oa(Pi);k=Pi.prototype;k.register=function(){Y(this,"click",this.da,"target");Y(this,"click",this.hide,"close");Qi(this)};
k.unregister=function(){Pi.w.unregister.call(this);Z(this,"click",this.da,"target");Z(this,"click",this.hide,"close");this.j&&(Lf(this.j),this.j=null);this.f&&(W(this.f),this.f=null)};
k.da=function(a){if(!this.b||!ch(this.b.b)){var b=this.B(a);a=Ri(b,a);b||(b=a?a.overlayParentNode:null);if(b&&a){var c=!!this.i(b,"disable-shortcuts")||!1,d=!!this.i(b,"disable-outside-click-dismiss")||!1;this.b=new Gi(a,c);this.g=b;var e=F("yt-dialog-fg",a);if(e){var f=this.i(b,"overlay-class")||"",g=this.i(b,"overlay-style")||"default",h=this.i(b,"overlay-shape")||"default";f=f?f.split(" "):[];f.push(X(this,g));f.push(X(this,h));Od(e,f)}this.b.show();Q("yt-uix-kbd-nav-move-to",e||a);Qi(this);c||
d||(c=v(function(a){K(a.target,"yt-dialog-base")&&Si(this)},this),this.f=V(F("yt-dialog-base",a),"click",c));
this.N(b,"overlay-shown");Q("yt-uix-overlay-shown",b)}}};
function Qi(a){a.j||(a.j=Jf("yt-uix-overlay-hide",Ti));a.b&&Ji(a.b,function(){var a=Pi.v();a.g=null;a.b.dispose();a.b=null})}
function Si(a){if(a.b){var b=a.g;a.b.dismiss("overlayhide");b&&a.N(b,"overlay-hidden");a.g=null;a.f&&(W(a.f),a.f=null);a.b=null}}
function Ri(a,b){var c;if(a)if(c=F("yt-dialog",a)){var d=E("body-container");d&&(d.appendChild(c),a.overlayContentNode=c,c.overlayParentNode=a)}else c=a.overlayContentNode;else b&&(c=G(b,"yt-dialog"));return c}
function Ui(){var a=Pi.v();if(a.g)a=F("yt-dialog-fg-content",a.g.overlayContentNode);else a:{if(a=Wb("yt-dialog-fg-content"))for(var b=0;b<a.length;b++){var c=G(a[b],"yt-dialog");if(ch(c)){a=a[b];break a}}a=null}return a}
k.hide=function(a){a&&a.disabled||Q("yt-uix-overlay-hide")};
function Ti(){Si(Pi.v())}
k.show=function(a){this.da(a)};var Vi={},Wi=[];function Xi(a){a=G(a,"yt-uix-button-subscription-container");return F("yt-dialog",F("unsubscribe-confirmation-overlay-container",a))}
function Yi(a,b){W(Wi);Wi.length=0;Vi[b]||(Vi[b]=Xi(a));Pi.v().show(Vi[b]);var c=Ui();return new Ke(function(a){Wi.push(qg(c,function(){a()},"overlay-confirmation-unsubscribe-button"))})}
;function Zi(){var a=O("PLAYER_CONFIG");return a&&a.args&&void 0!==a.args.authuser?!0:!(!O("SESSION_INDEX")&&!O("LOGGED_IN"))}
;function $i(){wg.call(this,"subscription-button")}
y($i,wg);oa($i);$i.prototype.register=function(){Y(this,"click",this.ea);yg(this,Ng,this.Da);yg(this,Og,this.Ca);yg(this,Pg,this.xb);yg(this,Sg,this.Da);yg(this,Tg,this.Ca);yg(this,Ug,this.zb);yg(this,Wg,this.wb);yg(this,Xg,this.vb)};
$i.prototype.unregister=function(){Z(this,"click",this.ea);$i.w.unregister.call(this)};
$i.prototype.isSubscribed=function(a){return!!this.i(a,"is-subscribed")};
var aj={ga:"hover-enabled",Oa:"yt-uix-button-subscribe",Pa:"yt-uix-button-subscribed",Fb:"ypc-enabled",Ra:"yt-uix-button-subscription-container",Sa:"yt-subscription-button-disabled-mask-container"},bj={Gb:"channel-external-id",Ta:"subscriber-count-show-when-subscribed",Ua:"subscriber-count-tooltip",Va:"subscriber-count-title",Ib:"href",Jb:"insecure",ha:"is-subscribed",Kb:"parent-url",Lb:"clicktracking",Za:"show-unsub-confirm-dialog",Mb:"show-unsub-confirm-time-frame",ab:"style-type",ia:"subscribed-timestamp",
ja:"subscription-id",Nb:"target",bb:"ypc-enabled"};k=$i.prototype;k.ea=function(a){var b=this.i(a,"href"),c=this.i(a,"insecure");if(b)a=this.i(a,"target")||"_self",window.open(b,a);else if(!c)if(Zi()){b=this.i(a,"channel-external-id");c=this.i(a,"clicktracking");var d=cj(this,a),e=this.i(a,"parent-url");if(this.i(a,"is-subscribed")){var f=this.i(a,"subscription-id"),g=new Jg(b,f,d,a,c,e);dj(this,a)?Yi(a,b).then(function(){U(Rg,g)}):U(Rg,g)}else U(Mg,new Hg(b,d,c,e))}else ej(this,a)};
k.Da=function(a){this.M(a.b,this.Fa,!0)};
k.Ca=function(a){this.M(a.b,this.Fa,!1)};
k.xb=function(a){this.M(a.b,this.Ga,!0,a.f)};
k.zb=function(a){this.M(a.b,this.Ga,!1)};
k.wb=function(a){this.M(a.b,this.hb)};
k.vb=function(a){this.M(a.b,this.gb)};
k.Ga=function(a,b,c){b?(Nf(a,bj.ha,"true"),c&&Nf(a,bj.ja,c),this.i(a,bj.Za)&&(b=new Kd,Nf(a,bj.ia,(b.getTime()/1E3).toString()))):(Qf(a,bj.ha),Qf(a,bj.ia),Qf(a,bj.ja));fj(this,a)};
function cj(a,b){if(!a.i(b,"ypc-enabled"))return null;var c=a.i(b,"ypc-item-type"),d=a.i(b,"ypc-item-id");return{itemType:c,itemId:d,subscriptionElement:b}}
k.Fa=function(a,b){var c=G(a,aj.Ra);Qd(c,aj.Sa,b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function fj(a,b){var c=a.i(b,bj.ab),d=!!a.i(b,"is-subscribed");c="-"+c;var e=aj.Pa+c;Qd(b,aj.Oa+c,!d);Qd(b,e,d);a.i(b,bj.Ua)&&!a.i(b,bj.Ta)&&(c=X(fh.v()),Qd(b,c,!d),b.title=d?"":a.i(b,bj.Va));d?P(function(){L(b,aj.ga)},1E3):M(b,aj.ga)}
k.hb=function(a){var b=!!this.i(a,"ypc-item-type"),c=!!this.i(a,"ypc-item-id");!this.i(a,"ypc-enabled")&&b&&c&&(L(a,"ypc-enabled"),Nf(a,bj.bb,"true"))};
k.gb=function(a){this.i(a,"ypc-enabled")&&(M(a,"ypc-enabled"),Qf(a,"ypc-enabled"))};
function gj(a,b){return Ea(Wb(X(a)),function(a){return b==this.i(a,"channel-external-id")},a)}
k.eb=function(a,b,c){var d=Na(arguments,2);A(a,function(a){b.apply(this,Ja(a,d))},this)};
k.M=function(a,b,c){var d=gj(this,a);this.eb.apply(this,Ja([d],Na(arguments,1)))};
function ej(a,b){var c=v(function(a){a.discoverable_subscriptions&&Cf("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.ea(b)},a);
nh(c)}
function dj(a,b){if(!a.i(b,"show-unsub-confirm-dialog"))return!1;var c=a.i(b,"show-unsub-confirm-time-frame");return"always"==c||"ten_minutes"==c&&(c=parseInt(a.i(b,"subscribed-timestamp"),10),(new Kd).getTime()<1E3*(c+600))?!0:!1}
;function hj(a){this.b=a;this.D=null;O("SUBSCRIBE_EMBED_HOVERCARD_URL")&&(ij(this),V(this.b,"mouseover",v(this.j,this)),V(this.b,"mouseout",v(this.X,this)),V(this.b,"click",v(this.X,this)),bg(Pg,za(this.f,!0),this),bg(Ug,za(this.f,!1),this),jj(this))}
function ij(a){var b={url:O("SUBSCRIBE_EMBED_HOVERCARD_URL"),style:"bubble",hideClickDetection:!0,show:!1,anchor:a.b,relayOpen:"-1"};a=v(a.g,a);Dg().open(b,a)}
function jj(a){Zi()||Jf("LOGGED_IN",function(){this.D&&(this.X(),this.D.close(),this.D=null,ij(this))},a)}
hj.prototype.g=function(a){this.D=a;a=$i.v().isSubscribed(this.b);this.f(a)};
hj.prototype.j=function(){this.D&&this.D.restyle({show:!0})};
hj.prototype.X=function(){this.D&&this.D.restyle({show:!1})};
hj.prototype.f=function(a){if(this.D){a={isSubscribed:a};try{this.D.send("msg-hovercard-subscription",a,void 0,u("gapi.iframes.SAME_ORIGIN_IFRAMES_FILTER"))}catch(b){}}};function kj(){Cg(function(){var a=we(E("yt-subscribe"));a={width:a.width,height:a.height};var b=lj;Dg().ready(a,null,b)})}
function lj(a){if(a.length&&a[a.length-1]){a=a[a.length-1].eurl;var b=E("yt-subscribe"),c=$i.v();if(b=F(X(c),b))a&&($i.v(),Nf(b,"parent-url",a)),new hj(b)}}
;function mj(a){R.call(this,1,arguments);this.b=a}
y(mj,R);function nj(a,b){R.call(this,2,arguments);this.f=a;this.b=b}
y(nj,R);function oj(a,b,c,d){R.call(this,1,arguments);this.b=b;this.f=c||null;this.itemId=d||null}
y(oj,R);function pj(a,b){R.call(this,1,arguments);this.f=a;this.b=b||null}
y(pj,R);function qj(a){R.call(this,1,arguments)}
y(qj,R);var rj=new S("ypc-core-load",mj),sj=new S("ypc-guide-sync-success",nj),tj=new S("ypc-purchase-success",oj),uj=new S("ypc-subscription-cancel",qj),vj=new S("ypc-subscription-cancel-success",pj),wj=new S("ypc-init-subscription",qj);var xj=!1,yj=[];function zj(a){a.b?xj?U(Qg,a):U(rj,new mj(function(){U(wj,new qj(a.b))})):Aj(a.f,a.j,a.g,a.source)}
function Bj(a){a.b?xj?U(Vg,a):U(rj,new mj(function(){U(uj,new qj(a.b))})):Cj(a.f,a.l,a.j,a.g,a.source)}
function Dj(a){Ej(Ka(a.b))}
function Fj(a){Gj(Ka(a.b))}
function Hj(a){Ij(a.g,a.f,a.b)}
function Jj(a){var b=a.itemId,c=a.b.subscriptionId;b&&c&&U(Pg,new Ig(b,c,a.b.channelInfo))}
function Kj(a){var b=a.b;Za(a.f,function(a,d){U(Pg,new Ig(d,a,b[d]))})}
function Lj(a){U(Ug,new Fg(a.f.itemId));a.b&&a.b.length&&(Mj(a.b,Ug),Mj(a.b,Wg))}
function Aj(a,b,c,d){var e=new Fg(a);U(Ng,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=O("PLAYBACK_ID"))&&(c.plid=d);(d=O("EVENT_ID"))&&(c.ei=d);b&&Nj(b,c);vh("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Ia:f,L:c,O:function(b,c){var d=c.response;U(Pg,new Ig(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&Q("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a)},
ca:function(){U(Og,e)}})}
function Cj(a,b,c,d,e){var f=new Fg(a);U(Sg,f);var g={};g.c=a;d&&(g.eurl=d);e&&(g.source=e);d={};d.c=a;d.s=b;(a=O("PLAYBACK_ID"))&&(d.plid=a);(a=O("EVENT_ID"))&&(d.ei=a);c&&Nj(c,d);vh("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Ia:g,L:d,O:function(){U(Ug,f)},
ca:function(){U(Tg,f)}})}
function Ij(a,b,c){if(a){var d={};d.channel_id=a;switch(b){case "receive-all-updates":d.receive_all_updates=!0;break;case "receive-no-updates":d.receive_no_updates=!0;d.receive_post_updates=!1;break;case "receive-highlight-updates":d.receive_all_updates=!1;d.receive_no_updates=!1;break;default:return}null===c||d.receive_no_updates||(d.receive_post_updates=c);var e=new Gg(a,b,c);vh("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",L:d,onError:function(){U($g,e)},
O:function(){U(Zg,e)}})}}
function Ej(a){if(a.length){var b=Ma(a,0,40);U("subscription-batch-subscribe-loading");Mj(b,Ng);var c={};c.a=b.join(",");var d=function(){U("subscription-batch-subscribe-loaded");Mj(b,Og)};
vh("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",L:c,O:function(c,f){d();var e=f.response,h=e.id;if(qa(h)&&h.length==b.length){var l=e.channel_info_map;A(h,function(a,c){var d=b[c];U(Pg,new Ig(d,a,l[d]))});
a.length?Ej(a):U("subscription-batch-subscribe-finished")}},
onError:function(){d();U("subscription-batch-subscribe-failure")}})}}
function Gj(a){if(a.length){var b=Ma(a,0,40);U("subscription-batch-unsubscribe-loading");Mj(b,Sg);var c={};c.c=b.join(",");var d=function(){U("subscription-batch-unsubscribe-loaded");Mj(b,Tg)};
vh("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",L:c,O:function(){d();Mj(b,Ug);a.length&&Gj(a)},
onError:function(){d()}})}}
function Mj(a,b){A(a,function(a){U(b,new Fg(a))})}
function Nj(a,b){var c=Bg(a),d;for(d in c)b[d]=c[d]}
;x("yt.setConfig",Cf);x("yt.config.set",Cf);x("ytbin.www.subscribeembed.init",function(){xj=!0;yj.push(bg(Mg,zj),bg(Rg,Bj));xj||yj.push(bg(Qg,zj),bg(Vg,Bj),bg(Kg,Dj),bg(Lg,Fj),bg(Yg,Hj),bg(tj,Jj),bg(vj,Lj),bg(sj,Kj));var a=$i.v(),b=X(a);b in Ag||(a.register(),xg(a,"yt-uix-init-"+b,a.init),xg(a,"yt-uix-dispose-"+b,a.dispose),Ag[b]=a);kj()});}).call(this);
